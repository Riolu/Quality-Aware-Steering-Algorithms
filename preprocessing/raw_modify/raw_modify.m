[num,txt,X]=xlsread('2013-08-07.csv'); %X记录原始数据  
%pickup_datetime  dropoff_datetime  trip_time_in_secs  pickup_longitude  pickup_latitude  dropoff_longitude  dropoff_latitude
...
for i = 1:m
    ...
    max_turn = max(max_turn,turn(i,2));
end
...
save(['New_York_8_7.mat'],'L','T','t1','t2','x1','y1','x2','y2','l1','l2');
